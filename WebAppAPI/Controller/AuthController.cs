...
namespace WebAppAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost("Login")]
        public async Task<ResponseValue<string>> Login(AuthLoginDTO loginDTO)
        {
            var result = await _authService.Login(loginDTO);
            return new ResponseValue<string>(result, "Đăng nhập thành công", StatusReponse.Success);
        }
        ...
        public async Task<ResponseValue<string>> DeleteAccount(int userId)
        {
