...
builder.Services.AddScoped<IPromoTemplateLayoutRepository, PromoTemplateLayoutRepository>();
...
{
    options.ValueLengthLimit = 1073741824; // 1GB
...
builder.Services.AddScoped<IPromoTemplateLayoutService, PromoTemplateLayoutService>();
