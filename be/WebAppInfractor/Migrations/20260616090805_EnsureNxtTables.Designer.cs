...
namespace WebAppInfractor.Migrations
{
    ...
    [Migration("20260616090805_EnsureNxtTables")]
    partial class EnsureNxtTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppInfractor.Models.NxtAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("Reason")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasDefaultValue("Đổi mã tạm/nhập nhầm")
                        .HasColumnName("reason");

                    b.Property<string>("RightCode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("right_code");
                    ...
                    b.Property<string>("WrongCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("wrong_code");

                    b.HasKey("Id");

                    b.ToTable("nxt_adjustments", (string)null);
                });

            modelBuilder.Entity("WebAppInfractor.Models.NxtClosing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("nxt_closings", (string)null);
                });

            modelBuilder.Entity("WebAppInfractor.Models.NxtGiftIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("nxt_gift_in", (string)null);
                });

            modelBuilder.Entity("WebAppInfractor.Models.NxtSapoImport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("RowsSaved")
                        .HasColumnType("integer")
                        .HasColumnName("rows_saved");
                    ...
                    b.Property<int>("TotalNetQty")
                        .HasColumnType("integer")
                        .HasColumnName("total_net_qty");
                    ...
                    b.ToTable("nxt_sapo_imports", (string)null);
                });

            modelBuilder.Entity("WebAppInfractor.Models.NxtSapoSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("NetSoldQty")
                        .HasColumnType("integer")
                        .HasColumnName("net_sold_qty");
                    ...
                    b.ToTable("nxt_sapo_sales", (string)null);
                });

            modelBuilder.Entity("WebAppInfractor.Models.NxtStockCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("nxt_stock_counts", (string)null);
                });
