                ...
                <Box>
                    ...
                    <Box
                        ...
                        sx={{
                            ...
                            '& video': { maxWidth: '100%', borderRadius: '8px', display: 'block', marginTop: '1.8em', marginBottom: '1.8em', marginLeft: 'auto', marginRight: 'auto', boxShadow: '0 2px 20px rgba(0,0,0,0.1)' },
