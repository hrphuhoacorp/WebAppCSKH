...
const dynamicStyles = {
    ...
    /* sapo pending items — compact horizontal rows */
    '.nxt .sp-card': { border: '1px solid #e5e7eb', borderLeft: '3px solid #f59e0b', borderRadius: '8px', marginBottom: 5, overflow: 'hidden', background: '#fff' },
    '.nxt .sp-card.done': { borderLeft: '3px solid #10b981', opacity: 0.8 },
    '.nxt .sp-card-main': { display: 'flex', alignItems: 'center', gap: 10, padding: '7px 12px' },
    '.nxt .sp-card-info': { flex: 1, display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' },
    '.nxt .sp-card-btns': { display: 'flex', gap: 6, flexShrink: 0 },
    '.nxt .sp-item-code': { fontWeight: 800, color: '#065f2d', fontSize: 13 },
    '.nxt .sp-item-meta': { fontSize: 12, color: '#6b7280' },
    '.nxt .sp-item-note': { fontSize: 11, color: '#92400e', fontStyle: 'italic' },
    '.nxt .sp-days': { display: 'inline-block', padding: '2px 8px', borderRadius: '99px', fontSize: 11, fontWeight: 700, flexShrink: 0 },
    ...
    '.nxt .sp-form': { display: 'none', padding: '8px 12px 10px', background: '#f0fdf4', borderTop: '1px solid #d1fae5' },
    '.nxt .sp-form.open': { display: 'block' },
    '.nxt .sp-form-grid': { display: 'grid', gridTemplateColumns: '150px 150px 1fr', gap: 8, marginBottom: 8 },
    '.nxt .sp-btn-primary': { background: '#065f2d', color: '#fff', border: 'none', borderRadius: '7px', padding: '5px 12px', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' },
    '.nxt .sp-btn-danger': { background: '#fee2e2', color: '#dc2626', border: '1px solid #fecaca', borderRadius: '7px', padding: '5px 10px', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' },
    '.nxt .sp-btn-cancel': { background: '#f3f4f6', color: '#374151', border: '1px solid #d1d5db', borderRadius: '7px', padding: '5px 12px', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' },
    '.nxt .sp-input': { width: '100%', border: '1px solid #d1d5db', borderRadius: '6px', padding: '5px 9px', fontSize: 12, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' },
    '.nxt .sp-label': { display: 'block', fontSize: 10, color: '#6b7280', fontWeight: 700, marginBottom: 3, textTransform: 'uppercase', letterSpacing: '.4px' },
