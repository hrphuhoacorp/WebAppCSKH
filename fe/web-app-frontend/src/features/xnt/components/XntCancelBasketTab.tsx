...
export default function XntCancelBasketTab() {
    ...
    const runPreview = (rawText: string) => {
        const rows = parseCodeQtyText(rawText, { date, branch, reason });
        setPreview(rows);
        setPreviewed(true);
        return rows;
    };
